    ...
    display(){
        ...
        if (this.color == 0){
            ...
            if (this.origin.x == 0 && this.origin.y == 0) {
                    ...
                    fill(254,246,182, 100);
                    stroke(254,246,182, 100);
                    ellipse(this.position.x,((this.origin.x-line_yellow[99][1])-array_band2[99]+array_band_hardcode[99]+72-array_band_hardcode[99]-this.botz*this.botz*(8.8)*0.3)*s_y,5)
            ...
            if (sceneCount ==2) {
             ...
             if (this.origin.x == 0 && this.origin.y == 0) {
                ...
                strokeWeight(1);
                ellipse(this.position.x,-3+(k+144)*s_y+this.botz*this.botz*(8.8)*0.3,5)
             } else {
                noFill();
                stroke(125, 241, 148,  100); //green
                strokeWeight(1);
                ellipse(this.position.x,-3+(this.origin.y-155.7)+(k+144+16)*s_y+this.botz*this.botz*(8.8)*0.3,5)
